            ...
            <div class="bg-white overflow-hidden p-8 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        {{-- Tampilkan icon yang sudah ada --}}
                        @if($category->icon)
                            <img src="{{ Storage::url($category->icon) }}" alt="Current Icon" class="w-16 h-16 object-cover rounded-lg mb-2">
                        @endif
                        <x-text-input id="icon" class="block mt-1 w-full" type="file" name="icon" />
                        <p class="text-sm text-gray-500 mt-1">Kosongkan jika tidak ingin mengganti icon.</p>
