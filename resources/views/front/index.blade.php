...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .btn-solid:hover{background:var(--brass-light);border-color:var(--brass-light);transform:translateY(-2px);}
  .btn-line{
  ...
  .avatar-box img{width:100%;height:100%;object-fit:cover;object-position:top center;display:block;}
  .avatar-box::before,.avatar-box::after{
    content:"";position:absolute;width:14px;height:14px;border:1px solid var(--brass-light);z-index:2;
  }
  ...
  .about-photo-frame{
    width:100%;aspect-ratio:4/5;background:linear-gradient(155deg,#1b2f4d,#0e1a2e);
    border:1px solid var(--brass);overflow:hidden;position:relative;
  }
  .about-photo-frame::before,.about-photo-frame::after{
    content:"";position:absolute;width:16px;height:16px;border:1px solid var(--brass-light);z-index:2;
  }
  .about-photo-frame::before{top:-1px;left:-1px;border-right:none;border-bottom:none;}
  .about-photo-frame::after{bottom:-1px;right:-1px;border-left:none;border-top:none;}
  .about-photo-frame img{width:100%;height:100%;object-fit:cover;object-position:top center;display:block;}
  .about-card{background:#fff;border:1px solid var(--line);padding:24px;margin-top:18px;}
  ...
  @media(max-width:1080px){
    ...
    .about-grid>div:first-child{max-width:340px;margin:0 auto;width:100%;}
...
<body>
  ...
  <section class="hero" id="hero" style="padding:0;">
    <div class="hero-grid">
      <div>
        ...
        <p class="hero-desc">Mahasiswa Sistem Informasi yang menekuni analisis data dan pengembangan sistem di sektor perbankan. Saat ini bertugas sebagai staff IT & Data di <strong>PT BPR Mitra Rakyat Riau</strong>, membantu proses digitalisasi layanan keuangan mikro agar lebih cepat, akurat, dan transparan.</p>
        <div class="hero-cta">
      ...
      <div class="passbook">
        ...
        <div class="passbook-body">
          <div class="avatar-box">
            <img src="{{ asset('assets/photo/reza.jpeg') }}" alt="Reza Akta Mavia">
          </div>
          <div>
    ...
    <div class="wrap">
      ...
      <div class="about-grid">
        ...
        <div class="about-text">
          ...
          <p>Di luar pekerjaan, saya mendedikasikan menjadi relawan pajak untuk membantu masyarakat memahami kewajiban perpajakan mereka. Saya percaya bahwa kemampuan teknis paling berguna ketika dibagikan kembali ke lingkungan sekitar.</p>
  ...
  <footer>
    <div class="wrap">
      ...
      <div class="foot-bottom">© 2026 Reza Akta Mavia · Sistem Informasi · Staff IT & Data, PT BPR Mitra Rakyat Riau</div>
    </div>
  </footer>
